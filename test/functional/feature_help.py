...
"""Verify that starting bilt with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bilt with -? for help text")
        ...
        self.log.info("Start bilt with -version for version information")
