...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BILT features */
        {"bilt", "listmasternodes", &listmasternodes, true },
        {"bilt", "getmasternodecount", &getmasternodecount, true },
        {"bilt", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"bilt", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"bilt", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"bilt", "masternodecurrent", &masternodecurrent, true },
        {"bilt", "startmasternode", &startmasternode, true },
        {"bilt", "createmasternodekey", &createmasternodekey, true },
        {"bilt", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"bilt", "listmasternodeconf", &listmasternodeconf, true },
        {"bilt", "getmasternodestatus", &getmasternodestatus, true },
        {"bilt", "getmasternodewinners", &getmasternodewinners, true },
        {"bilt", "getmasternodescores", &getmasternodescores, true },
        {"bilt", "preparebudget", &preparebudget, true },
        {"bilt", "submitbudget", &submitbudget, true },
        {"bilt", "mnbudgetvote", &mnbudgetvote, true },
        {"bilt", "getbudgetvotes", &getbudgetvotes, true },
        {"bilt", "getnextsuperblock", &getnextsuperblock, true },
        {"bilt", "getbudgetprojection", &getbudgetprojection, true },
        {"bilt", "getbudgetinfo", &getbudgetinfo, true },
        {"bilt", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"bilt", "mnfinalbudget", &mnfinalbudget, true },
        {"bilt", "checkbudgets", &checkbudgets, true },
        {"bilt", "mnsync", &mnsync, true },
        {"bilt", "spork", &spork, true },
...
{
    return "> bilt-cli " + methodname + " " + args + "\n";
}
