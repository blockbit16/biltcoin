...
/* Bilt GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Bilt"
#define QAPP_ORG_DOMAIN "bilt.org"
#define QAPP_APP_NAME_DEFAULT "Bilt-Qt"
#define QAPP_APP_NAME_TESTNET "Bilt-Qt-testnet"
