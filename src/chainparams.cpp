...
{
    const char* pszTimestamp = "bilt developed on 26th june 2022";
...
public:
    CMainParams()
    {
		...
		genesis = CreateGenesisBlock(1656484670, 609529, 0x1e0ffff0, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000002394e678e976430be4a74cccae08ce8b66ad48e31a13a0ce22d476d61f9"));
        assert(genesis.hashMerkleRoot == uint256S("0x958fb07ef2b9142d88e9ee9ffbfb17ab8505265016c4c92d63925968ca36daf9"));
        ...
        consensus.mBurnAddresses = {
            { "BFDu1cw2pVG8bZq62tEFCUG83PCJZLpDwk", 4000000 },
        };
        ...
        consensus.ZC_TimeStart = 1656484675;        // Thu Apr 25 04:06:18 AM +00 2019
        ...
        vSeeds.emplace_back(CDNSSeedData("seed1",  "31.187.76.64", true));
...
public:
    CTestNetParams()
    {
		...
		genesis = CreateGenesisBlock(1656347918, 234843, 0x1e0ffff0, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000b2bb803a2cfcbc11f82803a8c6f8c148041653880e79c609b72d0c4fe53"));
        assert(genesis.hashMerkleRoot == uint256S("0x958fb07ef2b9142d88e9ee9ffbfb17ab8505265016c4c92d63925968ca36daf9"));

        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.powLimit   = ~UINT256_ZERO >> 20;   // bilt starting difficulty is 1 / 2^12
        consensus.posLimitV1 = ~UINT256_ZERO >> 24;
        consensus.posLimitV2 = ~UINT256_ZERO >> 20;
        ...
        consensus.vUpgrades[Consensus::UPGRADE_TESTDUMMY].nActivationHeight              = Consensus::NetworkUpgrade::NO_ACTIVATION_HEIGHT;
        consensus.vUpgrades[Consensus::UPGRADE_POS].nActivationHeight                    = 501;
        consensus.vUpgrades[Consensus::UPGRADE_POS_V2].nActivationHeight                 = 901;
        consensus.vUpgrades[Consensus::UPGRADE_ZC].nActivationHeight                     = Consensus::NetworkUpgrade::NO_ACTIVATION_HEIGHT;
        consensus.vUpgrades[Consensus::UPGRADE_ZC_V2].nActivationHeight                  = Consensus::NetworkUpgrade::NO_ACTIVATION_HEIGHT;
        consensus.vUpgrades[Consensus::UPGRADE_BIP65].nActivationHeight                  = 931;
        consensus.vUpgrades[Consensus::UPGRADE_ZC_PUBLIC].nActivationHeight              = Consensus::NetworkUpgrade::NO_ACTIVATION_HEIGHT;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet bilt addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet bilt script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet bilt BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet bilt BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
        // Testnet bilt BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
		...
		genesis = CreateGenesisBlock(1656347918, 234843, 0x1effffff, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        // assert(consensus.hashGenesisBlock == uint256S("0x00000b2bb803a2cfcbc11f82803a8c6f8c148041653880e79c609b72d0c4fe53"));
        // assert(genesis.hashMerkleRoot == uint256S("0x958fb07ef2b9142d88e9ee9ffbfb17ab8505265016c4c92d63925968ca36daf9"));
