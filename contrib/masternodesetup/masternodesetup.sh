...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='bilt.conf'
CONFIGFOLDER='/root/.bilt'
COIN_DAEMON='biltd'
COIN_CLI='bilt-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/biltcoin-com/BILT/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
