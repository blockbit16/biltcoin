...
# Create zip file of binaries
	cp BILT/src/biltd BILT/src/bilt-cli BILT/src/bilt-tx BILT/src/qt/bilt-qt .
	zip BILT-$(git describe --abbrev=0 --tags | sed s/v//)-Linux.zip biltd bilt-cli bilt-tx bilt-qt
	rm -f biltd bilt-cli bilt-tx bilt-qt
