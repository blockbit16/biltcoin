...
# Create zip file of binaries
	cp BILT/src/biltd.exe BILT/src/bilt-cli.exe BILT/src/bilt-tx.exe BILT/src/qt/bilt-qt.exe .
	zip BILT-Windows.zip biltd.exe bilt-cli.exe bilt-tx.exe bilt-qt.exe
	rm -f biltd.exe bilt-cli.exe bilt-tx.exe bilt-qt.exe
