...
#define MyAppName "Bilt Core"
#define MyAppPublisher "2022 DECENOMY Core Developers"
#define MyAppURL "https://biltcoin.com"
#define MyAppExeName "bilt-qt.exe"
#define MyAppExtraData "https://explorer.decenomy.net/bootstraps/BILT/bootstrap.zip"
...
[Files]
Source: ".\package\bilt-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Bilt\Bilt-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Bilt\Bilt-Qt,strDataDir|{userappdata}\Bilt\}');
  Result := True;
end;
