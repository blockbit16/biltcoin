...
CAmount CMasternode::GetMasternodeNodeCollateral(int nHeight) 
{
    ...
    if(nHeight > 1200000) return 50000 * COIN;
    if(nHeight > 1100000) return 50000 * COIN;
    if(nHeight > 1000000) return 50000 * COIN;
    if(nHeight >  900000) return 50000 * COIN;
    if(nHeight >  800000) return 50000 * COIN;
    if(nHeight >  700000) return 50000 * COIN;
    if(nHeight >  600000) return 40000 * COIN;
    if(nHeight >  500000) return 30000 * COIN;
    if(nHeight >  400000) return 25000 * COIN;
    if(nHeight >  300000) return 20000 * COIN;
    if(nHeight >  200000) return 15000 * COIN;
...
CAmount CMasternode::GetBlockValue(int nHeight)
{
    ...
    if(nHeight > 1300000) return      27 * COIN;
    if(nHeight > 1200000) return      36 * COIN;
    if(nHeight > 1100000) return      54 * COIN;
    if(nHeight > 1000000) return      72 * COIN;
    if(nHeight >  900000) return      96 * COIN;
    if(nHeight >  800000) return     156 * COIN;
    if(nHeight >  700000) return     192 * COIN;
    if(nHeight >  600000) return     144 * COIN;
    if(nHeight >  500000) return     126 * COIN;
    if(nHeight >  400000) return     108 * COIN;
    if(nHeight >  300000) return      72 * COIN;
    if(nHeight >  200000) return      54 * COIN;
    if(nHeight >  100000) return      27 * COIN;
    if(nHeight >   10000) return      18 * COIN;
...
{
    return GetBlockValue(nHeight) * 2 / 3;
}
...
bool CMasternodeBroadcast::CheckInputsAndAdd(int& nDoS)
{
    ...
    // should be at least not earlier than block when 1000 BILT tx got MASTERNODE_MIN_CONFIRMATIONS
    uint256 hashBlock = UINT256_ZERO;
    CTransaction tx2;
    GetTransaction(vin.prevout.hash, tx2, hashBlock, true);
    BlockMap::iterator mi = mapBlockIndex.find(hashBlock);
    if (mi != mapBlockIndex.end() && (*mi).second) {
        CBlockIndex* pMNIndex = (*mi).second;                                                        // block for 1000 BILT tx -> 1 confirmation
