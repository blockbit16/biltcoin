Contributing to Bilt Core
============================

The Bilt Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Bilt Core project, and is not to be
confused with overall Bilt Network Protocol consensus changes.

Whether a pull request is merged into Bilt Core rests with the project merge
...
Patches that change Bilt consensus rules are considerably more involved than
...
Where a patchset proposes to change the Bilt consensus, it must have been
...
The project leader is the release manager for each Bilt Core release.
